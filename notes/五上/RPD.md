...
:::fbox 
![alt text](paste_src/RPD-17.png =50)
![alt text](paste_src/RPD-18.png =48)
:::
...
:::fbox 
![alt text](paste_src/RPD-26.png =30)
![alt text](paste_src/RPD-27.png =50)
:::
...
![alt text](paste_src/RPD-28.png =30)
...
![alt text](paste_src/RPD.png =60)

- #44 的 Rest 同時是 Inderect retainer

---
:::fbox 
![alt text](paste_src/RPD-1.png =27)
![alt text](paste_src/RPD-2.png =34)
![alt text](paste_src/RPD-3.png =39)
:::
...
:::right
![alt text](paste_src/RPD-6.png)
:::


- Distortion of tissue
  - 解法: 印模的時候用力把 soft tissue 往下壓
![alt text](paste_src/RPD-7.png)
...
| |Mx |Md |
|-|-|-|
| |![alt text](paste_src/RPD-8.png).|![alt text](paste_src/RPD-9.png).|
...
![alt text](paste_src/RPD-10.png)


- Indrect retainer 限制 Denture Base 

![alt text](paste_src/RPD-11.png)
...
導引類型 (Guidance / Occlusion) |下顎由外側方閉合 (Lateral) |下顎由前方閉合 (Protrusive)
|-|-|-|
Fully Balanced Occlusion | 工作側 + 平衡側後牙 |全部前牙 + 全部後牙
Balanced Occlusion |部分工作側 + 部分平衡側後牙 |前牙 + 部分後牙
Bilateral Balanced Occlusion |工作側 + 平衡側後牙 |前牙 
Unilateral Balanced Occlusion |全部工作側 |-
Group Function <br> (Simultaneous working contact) | 工作側 3, 4, 5, 6, 7 |-
Partial Group Function |工作側 3, 6, 7  |-
Anterior Group Function |1, 2, 3 |-
Cuspid Guidance |3  |-


| 類別 | 咬合設計原則 | 理由 |
|------|--------------|------|
| 上下 CD | \oneline{Fully balanced occlusion 或 Balanced occlusion} | \oneline{為維持下顎義齒穩定，上顎常落於危險區，因此需雙側平衡咬合以抵銷側向力} |
| 上顎 Single CD, Class I RPD | \oneline{Bilateral balanced occlusion} | \oneline{上顎骨向內吸收，排牙易落於危險區，需平衡咬合維持穩定} |
| 上顎 Class II RPD | \oneline{Simultaneous working contact} | \oneline{對側有牙鉤提供穩定，只需工作側均勻接觸} |
| 下顎 Single CD, Class I / II RPD| \oneline{Simultaneous working contact} | \oneline{排牙可位於支點內安全區，不需平衡咬合} |
| Class III RPD| \oneline{依原本咬合形式} | \oneline{缺牙數少，可依患者原有咬合重建} |
| Class IV RPD| \oneline{M.I. 均勻接觸；離心時 edge-to-edge} | \oneline{前牙主導，離心運動時需避免干擾} |
...
1920 McCollum|最後位置
1958 Grange|最後最上位置
1961 Lucia，Stuart|最後最上最中位置(RUM)
1973 Dawson|最上位置
1978 Celenza，Nasedkin|condyle-disc-complex互相頂好，向上向前頂向Articular Eminence
1983 Giboe|Condyle緊頂著disc中央最薄處(沿用至今)
