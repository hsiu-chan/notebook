...
- Endodontically treated teeth (ETT) more brittle or fragile?
  - 含水量跟 vital 差不多 
  - Margin 破壞 &rarr; flexibility &darr;
  - 無法控制咬力
...
- Complete-coverage crown + Core
  - 不一定要 Post
- Full metal &rarr; Zirconia
- 齒質結構好可考慮 onlay 
#### 前牙 

- 齒質多：Resin
- 齒質少、美觀考量：Post & Core + Crown(Veneer)
- 下顎前牙predentin wall 較薄 &rarr; fiber post
...
![alt text](paste_src/FPD-13.png)


:::info { Two step v.s. One step}
...
- 過硬(base metal) &rarr; Root fracture 
- 過軟 (Gold) &rarr; 
  - Post 脫落
  - Flexibility &rarr; Crown marginal leakage
- tooth structure夠用較軟 Post ，反之選 Rigid
  - 後牙一般用軟 Post 

>\style[color: red;]{Prefabricated}: 預製成固定尺寸與形狀

| 材質種類||性質|
|-|-|-|
Metal| Cast (precious)|noble alloy, Fit|
|^| \style[color: red;]{ SS/ Ti}|\oneline{
- 強度高，彈性模數高
- Resin 結合能力差}|
Woven fiber||\oneline{
- woven fiber + resin matrix
- 多方向纖維、抗裂性佳、能吸收應力
- 美觀
}|
|單向纖維|\style[color: red;]{Carbon fiber}|\oneline{
- E: 20–40 GP
- 美觀差(黑)，少用
- 易取出， Retrievable
}|
| ^|\style[color: red;]{Glass/ Quartz fiber}| \oneline{
- E: 18–25 GPa (\~Dentin)
- 白色，美觀
- 可與 Dentin 黏著，但仍易取出
}|
|^|Polyethylene fiber (Ribbond)| \oneline{
- 柔軟可塑，可直接在根管內層壓成形
}
Ceramic (Zirconia) ||\oneline{
- 美觀
- 非常堅硬
- 難以取出
}|
...
| Cement 類型 | 特性 / 注意事項 | |
|-------------|----------------|-----------|
| Polycarboxylate cement <br> (PCC) | \oneline{
- 會有塑性變形（plastic deformation）
- 絕對不能用於 post-core，否則樁容易鬆脫 }|
|Zinc Phosphate Cements (ZPC)|\oneline{
- 沒有Adhesive
}|
|GI|\oneline{
- 濕度控制，小心口水干擾。
- Delay preparation」(24hrs)}
| RMGI | 早期版本會膨脹，現代已多改善，但仍需注意膨脹與黏著力問題 |
| Resin cement | \oneline{
- 黏著力強，適用 fiber post 
- 需控制污染
- Eugenol 需清除（用EDTA）
- 光固化深度可能不足 → self-cure/ dual-cure 
} |
| Screw post | \oneline{
- 螺紋 + cement 組合基本上不可拆
- 不可用力拔除，拔除時牙根幾乎會連同樁被拔出}|
...
- 長度：影響受力、固位性
  - 太短 &rarr; root wall, Cervical 應力
  - 太長 &rarr; 影響Apical hermetic seal
  - 建議到牙根的Middle-third
- 表面設計：粗糙
- 形狀
![alt text](paste_src/FPD-15.png)
...
|------|-----------------|------------------|
| **特質** | 1. 可針對各種形態的根管密合<br>2. Custom cast core 可以避免 coronal dentin 大量損失 | 1. 無法和所有 canal 密合<br>2. 較省時，可一次完成<br>3. 相對較便宜 |
| **密合度** | 高 | 一般 |
| **保留齒質** | 高 | 中等 (要配合 Cast) |
...
|----------------|---------------|
| **Amalgam core** | \oneline{
- 強度很好
- 與牙齒無 adhesive
- 24hrs 硬化}|
| **Composite** |\oneline{
- 常用，分層堆疊
- Bulk-fill 可一次堆大坨，光照固化}|
| **Glass ionomer** | \oneline{
- 生物相容性佳，可釋放氟
- 強度略低於 composite resin }|
...
1. Apical GP>3mm (最好 5mm)
2. Minimal canal preparation
3. Adequate post length
   - retention
   - canal的1/2~2/3, middle root:若放在cervical反而會造成力量集中，fracture
   - 要到 alveolar bone 下
4. Definite vertical stop (for casting)
   - 避免 Try in 產生 wedge effect
5. Anti-rotation effect: 別讓 Post 旋轉 
6. ferrule
   - sound tooth structure 至少高 1.5-2mm，厚 0.5~1mm 

![alt text](paste_src/FPD-14.png =80)



:::tip {牙齒結構不足，沒有Ferrule effect}
...
![alt text](paste_src/FPD-12.png =40)
