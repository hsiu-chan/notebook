...
![](paste_src/2022-10-03-19-32-10.png)
![](paste_src/2022-10-03-19-32-29.png)
...
2[CN V2]-- oramen<br>rotundum -->pf([Pterygopalatine<br>Fossa])
pf-->psa[PSA]
pf-->i[Infraorbital n.] & z[Zygomatic n.]
pf-->gl[Pterygopalatine<br> ganglion]
```
...
flowchart LR
0[CN VII 顱內]
1((Inter<br>acoustic<br>meatus))
c((Stylomastoid<br>foramen))
pab[posterior auricular branch]

0==>1
c-->pab
1==>c
1-->ct[Chorda tympanic]--Petrotympanic fissure-->l[Lingual n.]
...
支配前$\frac{2}{3}$味覺, Submandibular, Sublingual [gland](#gland)
...
!!!warning [Lesser petrosal n.](#lesser-petrosal-n)
...
![](paste_src/2022-10-07-19-44-11.png)
:::warning{[Greater petrosal n.](#great-petrosal-and-vidian)}
:::

## CN X

- common carotid a. 外側，蓋在 thyrocervical trunk 上
- Superior thyroid n. 支配laryngeal
...
gp-->v-->pga([Pterygopalatine<br>ganglion])-->z[Zygomatic n.]-->lc[Lacrimal n.]-->ag[(Lacrimal g.)]

click pga "#pterygopalatine-ganglion"
click a "#posterior-division"
click l "#posterior-division"
click lp "#lesser-petrosal-n"
...
# 舌頭
![](paste_src/2022-11-30-22-44-48.png)
## Structure
...
![](paste_src/2022-11-05-15-05-55.png)
...
- salpingopharyngeus m.
   ...
   - Cartilage of pharyngotympanic tube $\rightarrow$ thyroid cartilage and pharyngeal wall
