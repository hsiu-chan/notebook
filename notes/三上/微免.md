...
|PicoRNA|HAV, EV, Rhinovirus |&cross;|ss linear RNA(+)|
...
Delayed-type hypersensitivity reactions <br> (DTH，延遲型)| Hapten(半抗原)+ Carrier(體內的蛋白質)=抗原 <br> (T~H1,2~ 主導，Cytokine 吸引 Macrophage)| 結核菌素 <br> (Skin tes)|
