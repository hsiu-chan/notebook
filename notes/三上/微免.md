...
- 結構
  ...
  - 2 spikes
  - ambisense 
![Alt text](paste_src/%E5%BE%AE%E5%85%8D-91.png)
...
|Hepadnarvirus (肝病毒科)|HBV| &check;| 大概是 ds circular DNA|
| Reoviruses|Orthoreovirus<br> Rotavirus <br> Orbivirus/Coltivirus|&cross;|多段 ds RNA|
|Orthomyxoviridae|流感病毒| &check;| 多段 ss RNA (-)|
|Paramyxoviridea| measles <br> mumps <br> RSV <br> Parainfluenza| &check;| ss linear RNA(-)|
Togaviridae <br> 披衣病毒| Chikungunya <br> Rubella| &check;| ss RNA(+)|
|Flaviviridae <br> 黃病毒科|HCV,日本腦炎病毒,<br>yellow fever,<br>West Nile, <br>dengue(登革熱) <br> Zika virus (茲卡)|&check;|ss linear RNA(+)|
|Arenaviridae|Lassa fever|&check;|2 ss circular RNA(-)|
|Bunyaviridae|Hantavirus|^|3 ss circular RNA(-)|
Filoviridae|Ebola|^|ss RNA(-)|
| HDV ||&check;|ss circular RNA(-)|
|Retroviruses||&check;|兩條相同 ss RNA(+)|
