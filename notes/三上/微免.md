...
### Signal 2
- 只有 Primer 有，執行功能時不需要

![Alt text](paste_src/微免-029.png)
...
![Alt text](paste_src/微免-032.png)

#### T~H~17 

- 促進 neutrophils 產生

![Alt text](paste_src/微免-033.png)
...
### Affinity maturation
- T cell 的 IL 4, CD40 觸發
- 根 Dendritic cell 搶， Affinity 高存活


### Isotype switch

- IgM 是剪接 RNA ，進入 Isotype switch 會剪接 DNA
- 轉變B cell 分泌類型
...
#### Class switching by gene recombination(就是 DNA 層級)

選擇性切掉不要的，接的紅點後面，就是呈現的東西。

![Alt text](paste_src/%E5%BE%AE%E5%85%8D-38.png)
#### 免疫過程 
